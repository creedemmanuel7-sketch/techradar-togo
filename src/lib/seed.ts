...
export async function seedDatabase() {
  ...
  try {
    ...
    const talents: UserProfile[] = [
    {
      ...
      role: "talent",
      bio: "Développeur Fullstack passionné par les technologies web modernes et la résolution de problèmes locaux. Spécialisé en React et Node.js. J'adore les hackathons !",
      location: "Lomé, Togo",
      skills: "React, Node.js, TypeScript, Tailwind CSS, Hackathon, Innovation, Python",
